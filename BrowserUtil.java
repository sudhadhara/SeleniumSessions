...
public class BrowserUtil {
	...
	public WebDriver init_driver(String browserName) {
		...
		case "chrome":
			...
			WebDriverManager.chromedriver().setup();// It will keep the browsers and .exe in sync.
			driver = new ChromeDriver(); 
			//if you have already declared int a on top and again u dont have to declared but can assign
			break;
		case "firefox":
